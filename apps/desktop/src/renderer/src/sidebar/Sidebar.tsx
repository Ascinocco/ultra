...
export function Sidebar() {
  ...
  function handleChatContextMenu(event: React.MouseEvent, chat: import("@ultra/shared").ChatSummary) {
    event.preventDefault()
    setContextMenu({ chat, x: event.clientX, y: event.clientY })
  }

  function handleRename(chat: import("@ultra/shared").ChatSummary) {
  ...
  function handleTogglePin(chat: import("@ultra/shared").ChatSummary) {
    if (chat.isPinned) {
  ...
  function handleArchive(chat: import("@ultra/shared").ChatSummary) {
